...
KWARGS = {
    ...
    'description' : 'Implementation of MCMC in the Vaby framework',
    'long_description' : get_filetext(MODULE_DIR, 'README.md'),
    'long_description_content_type' : 'text/markdown',
    'author' : 'Martin Craig, Jose Manzano Patron, Tom Kirk, Michael Chappell, Mark Woolrich',
